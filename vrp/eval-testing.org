...
#+BEGIN_SRC lisp +n -r :results none :exports both :tangle ../src/eval-tutorial.lisp
      (undo-suite-operations graph (list (op-insert-client 2 5 2)))
#+END_SRC
...
:   <r2: <cv:2. 0/10> (<d:0>: (<c2: 1> <c4: 3> <c5: 2> <c6: 1> <c1: 1> <d:0>))>
: 
...
<EVAL-GRAPH: 
 ...
 inputs: 
  ...
  <Cliient node <c1: 1>, 
     ...
     demand-calculator: decrement-capacity: <value: 5>>>
  <Cliient node <c2: 1>, 
     first-distance-calculator: <output: <value: 11>>, 
     second-distance-calculator: <output: <value: 11>>, 
     demand-calculator: decrement-capacity: <value: 3>>>
  <Cliient node <c3: 4>, 
     first-distance-calculator: <output: <value: 11>>, 
     second-distance-calculator: <output: <value: 11>>, 
     demand-calculator: decrement-capacity: <value: 5>>>
 ...
 client-buffer: #<HASH-TABLE :TEST EQL :COUNT 0 {1003AC6653}> 
